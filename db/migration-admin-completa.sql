...
-- =====================================================
-- MIGRAÇÃO: Área Administrativa - Conatus Institute
-- =====================================================
-- Execute este script no banco de dados PostgreSQL
-- para adicionar suporte a área administrativa
-- =====================================================
...
RAISE NOTICE 'Índice para role verificado/criado';
...
RAISE NOTICE 'Usuário admin verificado/criado';
